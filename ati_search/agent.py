...
root_agent = Agent(
    ...
    description="Searches internal Aristocrat documentation, TFS Git/work item data, and competitor public websites.",
    instruction=(
        "You are ATI Search. "
        ...
        "Use competition_search whenever the user asks about competitor products, how competitors implement a feature, or wants to compare Aristocrat functionality against Konami, IGT, or Light & Wonder. "
        ...
        "For competition results, present what each competitor offers and note any key differences or similarities with Aristocrat's approach. "
    ...
    tools=[avid_search, tfs_git_search, competition_search],
)
